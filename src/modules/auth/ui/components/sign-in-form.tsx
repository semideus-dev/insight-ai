    ...
    <Form {...form}>
      <form className="space-y-8" onSubmit={form.handleSubmit(onSubmit)}>
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="insight@ai.com" type="email" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <div className="after:border-border relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t">
          <span className="bg-white/10 backdrop-blur-2xl rounded-full border  text-muted-foreground relative z-10 px-2">
            OR
          </span>
        </div>
        <SocialAuth />
